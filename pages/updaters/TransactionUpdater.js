...
export default function Updater() {
    ...
    const state = store( state => state.transactions )
    const finalizeTransaction = store( state => state.finalizeTransaction )
    const checkedTransaction = store( state => state.checkedTransaction )
